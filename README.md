...
You have to design & build the backend for the application and the ability for the users to register, review companies, write interview experience etc.
...
https://github.com/azaylamba/glassdoorreviews 
